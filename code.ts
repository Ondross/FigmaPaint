...
function erase(eraserNode, allNodes) {
  ...
  const subtractionNodes = figma.currentPage.findAll(node => node.type === "BOOLEAN_OPERATION") as VectorNode[]
...
let eraser: VectorNode | null = null
let eraserNumVertices: number = 0
